...
public abstract class Animal {
    ...
    public Animal(String nomePopular, String nomeCientifico, GrupoAnimal grupo, double peso, double altura){
    ...
    public void mostrarInformacoes(){
        ...
        System.out.println("e é um " + Familia.valueOf(grupo.toString().toLowerCase()));
